...
/// TODO
#[no_mangle]
pub extern "C" fn fxa_mgr_get_profile(handle: u64, error: &mut ExternError) -> Option<ByteBuffer> {
    log::debug!("fxa_mgr_get_profile");
    MANAGER
        .call_with_output_mut(error, handle, |mgr| {
            mgr.get_profile()
...
/// TODO
#[no_mangle]
pub extern "C" fn fxa_mgr_update_profile(
    handle: u64,
    error: &mut ExternError,
) -> Option<ByteBuffer> {
